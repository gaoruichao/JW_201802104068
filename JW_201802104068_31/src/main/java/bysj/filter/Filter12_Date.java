...
@WebFilter(filterName = "Filter 12", urlPatterns = {"/*"})
public class Filter12_Date implements Filter {
    @Override
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        System.out.println("Filter 12 - date begins");
        ...
        System.out.println("Filter 12 - date ends");
    }
}
